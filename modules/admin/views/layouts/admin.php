...
?>
    ...
    <head>
        ...
        <?= Html::csrfMetaTags() ?>
        <title>Админка</title><?= Html::encode($this->title) ?></title>
        <!--[if lt IE 9]>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home(); ?>"> <?= Html::img("@web/images/home/logo.png", ['alt' => 'Eshopper']); ?></a>
                        </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="<?= Url::to(['customer/index']) ?>">Покупатели</a></li>
